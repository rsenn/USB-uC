...
#define PICDEM                                                                 \
  0 // Compatible with DM163025-1
    // https://www.microchip.com/DevelopmentTools/ProductDetails/DM163025-1.
#define P_STAR                                                                 \
  1 // Compatible with Pololu's P-Star dev boards
    // https://www.pololu.com/category/217/p-star-programmable-controllers.
...
//#define BUTTON_ANSEL_BIT  // Uncomment and define the Button's pin to make
// digital (if needed). #define BUTTON_ANSEL      // Uncomment and define the
// ANSEL register. #define BUTTON_WPU_BIT    // Uncomment and define the
// Button's Weak Pull-Up pin (if needed). #define BUTTON_WPU        // Uncomment
// and define the WPU register.
#define BUTTON_ACTIVE_LOW // Uncomment to make the Bootloader Button active low.
...
// WPUE3 (pull-up for RE3/MCLRE) needs to be accessable with PIC18F2XK50 (28 pin
// devices).
#if 0 //! defined(TRISE)
#define TRISE TRISE
